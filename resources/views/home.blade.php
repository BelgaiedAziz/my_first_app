...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="{{ asset('css/heroSection.css') }}" rel="stylesheet">
        <link href="{{ asset('css/featuresSection.css') }}" rel="stylesheet" >
        <link href="{{ asset('css/urgentNeedSection.css') }}" rel="stylesheet" >
        <link href="{{ asset('css/stats.css') }}" rel="stylesheet" >
        <link href="{{ asset('css/CTASection.css') }}" rel="stylesheet" >
        <link href="{{ asset('css/centreSection.css') }}" rel="stylesheet" >
        <link href="{{ asset('css/testimonialSection.css') }}" rel="stylesheet" >
...
<style>
    ...
    <div class="home-page">
        ...
        @include('components.navbar-section')
        @include('components.hero-section')
        @include('components.urgentNeed-section')
        @include('components.stats-section')
        @include('components.features-section')
        @include('components.centre-section')
